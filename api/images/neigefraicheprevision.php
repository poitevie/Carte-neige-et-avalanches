...
function generateImage($filenumber) {
    global $path_altitude, $fileext, $hgt_value_size, $pas_rayure, $pluie_couleur, $limiteneigefraicheprevision, $pluie_couleur2, $couleurFin, $couleurDebut, $path_neigefraicheprevision, $imageext, $offset_couleur_contour;
    if ($filenumber != "") {
